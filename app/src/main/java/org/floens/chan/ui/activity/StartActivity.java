...
public class StartActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Fully edge-to-edge: no padding on root view.
        // Insets are handled by individual views (toolbar gets top padding).

        // NFC Android Beam was removed in Android 14 (API 33+), skip setup

        setupFromStateOrFreshLaunch(savedInstanceState);

        // Handle back gesture for Android 14+ predictive back
