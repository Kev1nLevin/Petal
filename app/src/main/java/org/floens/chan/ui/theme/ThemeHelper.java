...
public class ThemeHelper {
    ...
    public ThemeHelper() {
        ...
        themes.add(new Theme("Material You", "material_you", R.style.Chan_Theme_MaterialYou, PrimaryColor.TEAL));
        themes.add(new DarkTheme("Material You Dark", "material_you_dark", R.style.Chan_Theme_MaterialYouDark, PrimaryColor.TEAL));
    ...
    public void setupContext(Activity context) {
        ...
        // For Material You themes, re-resolve all colors from the activity context
        // since dynamic colors are only available after DynamicColors applies
        if (theme.isMaterialYou()) {
            theme.resolveColorsFromActivity(context);
        }
        ...
        if (theme.isMaterialYou()) {
            // Use dynamic primary color for task description
            int dynamicPrimary = MaterialColors.getColor(context, com.google.android.material.R.attr.colorPrimary, theme.primaryColor.color);
            Bitmap icon = BitmapFactory.decodeResource(context.getResources(), R.drawable.ic_task_description);
            context.setTaskDescription(new ActivityManager.TaskDescription(null, icon, dynamicPrimary));
        } else {
            Bitmap icon = BitmapFactory.decodeResource(context.getResources(), R.drawable.ic_task_description);
